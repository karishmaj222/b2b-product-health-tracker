...
The full report (`.pbix`) is in ['dashboards/'](dashboards/BtoB Analyses_1000 accounts.pbix), and a PDF export is in [`dashboards/`](dashboards/B2B_Product_Health_Tracker.pdf).
