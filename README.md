...
The full report (`.pbix`) is in [`dashboards/BtoB Analyses_1000 accounts.pbix`](dashboards/BtoB Analyses_1000 accounts), and a PDF export is in [`dashboards/`](dashboards/B2B_Product_Health_Tracker.pdf).
